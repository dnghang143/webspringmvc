    ...
    <div class="product_page_right clearfix">
	 <div class="product_page_right_1 clearfix">
	  ...
	  <div class="col-sm-6">
		...
		<!-- THÊM CHỖ NÀY VÀO HIỂN THỊ UI -->
		<div class="pagination">
		    <ul class="pager">
		        <c:if test="${currentPage > 1}">
		            <li><a href="<c:url value='/product/pro/${currentPage - 1}.htm' />"><span class="glyphicon glyphicon-hand-left"></span></a></li>
		        </c:if>
		        <c:if test="${currentPage < totalPages}">
		            <li><a href="<c:url value='/product/pro/${currentPage + 1}.htm' />"><span class="glyphicon glyphicon-hand-right"></span></a></li>
		        </c:if>
		    </ul>
		</div>
	   </div>
